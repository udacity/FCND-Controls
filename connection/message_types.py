...
class StateMessage(Message):
    ...
    def __init__(self, timestamp, armed, guided):
...
class LocalFrameMessage(Message):
    ...
    def __init__(self, timestamp, north, east, down):
        super().__init__(timestamp)
        self._north = north
        self._east = east
        self._down = down
...
class FrameMessage(Message):
    ...
    def init_euler(self, timestamp, roll, pitch, yaw):
        super().__init__(timestamp)
    ...
    def init_quaternion(self, timestamp, q0, q1, q2, q3):
        super().__init__(timestamp)
        self._q0 = q0
        self._q1 = q1
        self._q2 = q2
        ...
        self._yaw = math.degrees(math.atan2(2.0 * (q0 * q3 + q1 * q2), 1.0 - 2.0 * (q2 ** 2 + q3 ** 2)))
...
class DistanceSensorMessage(Message):
    ...
    def __init__(self, timestamp, min_distance, max_distance, direction, measurement, covariance):
        super().__init__(timestamp)
